...
const MissionAndVisionData = [
    {
        ...
        imageUrl: "assets/images/vision1.webp"
    },
    {
        title: "Vision",
        ...
        imageUrl: "assets/images/vision2.webp"
    }
]

const missionData = JSON.stringify(MissionAndVisionData)
localStorage.setItem("mission & vision data", missionData)

export default MissionAndVisionData
